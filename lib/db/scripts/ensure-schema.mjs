...
const statements = [
  ...
  `CREATE TABLE IF NOT EXISTS user_profiles (
    ...
    total_potential REAL NOT NULL DEFAULT 0,
     day_potential REAL NOT NULL DEFAULT 0,
     day_potential_day TEXT,
  ...
  `ALTER TABLE user_profiles
     ADD COLUMN IF NOT EXISTS day_potential REAL NOT NULL DEFAULT 0`,
  `ALTER TABLE user_profiles
     ADD COLUMN IF NOT EXISTS day_potential_day TEXT`,
  `ALTER TABLE user_profiles
     ADD COLUMN IF NOT EXISTS closed_days INTEGER NOT NULL DEFAULT 0`,
  ...
  `ALTER TABLE completed_techniques
     ADD COLUMN IF NOT EXISTS potential_awarded REAL NOT NULL DEFAULT 0`,
  ...
  `CREATE INDEX IF NOT EXISTS referral_coupons_claimed_by_user_idx
     ON referral_coupons(claimed_by_user_id)`,
];
