...
const COST_KEYS = 25000;
const COST_RUB = 999;
const TG_KEYS = "https://t.me/Mtatarinov?text=%D0%9F%D1%80%D0%B8%D0%B2%D0%B5%D1%82.%20%D0%AF%20%D0%BD%D0%B0%D0%BA%D0%BE%D0%BF%D0%B8%D0%BB%20%D0%BA%D0%BB%D1%8E%D1%87%D0%B8%20%D0%B8%20%D1%85%D0%BE%D1%87%D1%83%20%D0%BE%D0%B1%D0%BC%D0%B5%D0%BD%D1%8F%D1%82%D1%8C%20%D0%B8%D1%85%20%D0%BD%D0%B0%20%D0%BA%D0%BE%D0%BD%D1%81%D1%83%D0%BB%D1%8C%D1%82%D0%B0%D1%86%D0%B8%D1%8E.";
const TG_RUB = "https://t.me/Mtatarinov?text=%D0%9F%D1%80%D0%B8%D0%B2%D0%B5%D1%82.%20%D0%A5%D0%BE%D1%87%D1%83%20%D0%B7%D0%B0%D0%BF%D0%B8%D1%81%D0%B0%D1%82%D1%8C%D1%81%D1%8F%20%D0%BD%D0%B0%20%D0%BA%D0%BE%D0%BD%D1%81%D1%83%D0%BB%D1%8C%D1%82%D0%B0%D1%86%D0%B8%D1%8E.";
...
export default function Consultation() {
  ...
  const handlePayKeys = async () => {
    ...
    try {
      if (isSignedIn) {
        await purchaseService("consultation", id);
        await refreshProfile();
      } else {
        updateState(prev => ({
          keys: prev.keys - COST_KEYS,
          keysHistory: [
            { date: new Date().toISOString(), source: 'Консультация', amount: COST_KEYS, type: 'spend' as const },
            ...prev.keysHistory,
          ],
          purchaseHistory: [
            { id, type: 'consultation', method: 'keys', amount: COST_KEYS, date: new Date().toISOString() },
    ...
    <ScreenTransition className="pt-[56px] px-4 pb-24 flex flex-col min-h-screen relative">
      ...
      <div className="flex-1 mt-4">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h1 className="title-l text-primary">Консультация</h1>
        </div>

        <div className="space-y-4 body text-secondary leading-relaxed mb-8">
          <p>Личная консультация — это часовой разбор твоей текущей ситуации.</p>
          <p>Мы определим узкие места, где ты теряешь энергию, и выстроим стратегию интеграции системы НейроХакинг под твой график.</p>
          <p>Консультация проводится в Telegram или Zoom.</p>
        </div>
