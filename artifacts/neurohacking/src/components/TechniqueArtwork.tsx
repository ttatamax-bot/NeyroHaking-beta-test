...
export function TechniqueArtwork({ kind, color, done = false, highlighted = false, pressed = false }: TechniqueArtworkProps) {
  ...
  return (
    <div className="relative flex h-[clamp(156px,39vw,172px)] w-full items-center justify-center">
      <motion.div
        className="relative flex aspect-square w-[clamp(140px,39vw,164px)] items-center justify-center overflow-visible rounded-[24px] border"
        style={{
